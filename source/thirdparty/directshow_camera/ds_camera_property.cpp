...
#pragma endregion Getter
    ...
    */
    void DirectShowCameraProperty::importProperty(bool supported, long min, long max, long step, long def, bool isAuto, long value, bool supportAuto, bool supportManual)
    {
        m_min = min;
        m_max = max;
        m_step = step;
